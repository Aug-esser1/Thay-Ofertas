...
import { ShoppingBag, Info, Mail, ShieldCheck, BookOpen, Menu, X } from 'lucide-react';
...
export default function Layout() {
  ...
  const navLinks = [
    ...
    { name: 'Guia de Compras', path: '/guias', icon: <BookOpen size={18} /> },
  ...
  return (
    <div className="min-h-screen bg-brand-bg font-sans text-ink lg:grid lg:grid-cols-[300px_1fr] lg:grid-rows-[1fr_auto]">
      ...
      <footer className="lg:col-span-2 bg-ink text-white/90 px-4 lg:px-10 py-6 text-[11px] leading-relaxed">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0">
          <div className="flex-1">
            <span className="text-brand-primary font-bold uppercase mr-3">Política de Afiliados:</span>
          ...
          <div className="md:ml-10 flex space-x-6 border-t md:border-t-0 border-white/10 pt-4 md:pt-0 shrink-0 uppercase tracking-widest font-bold">
